...
<main>
  ...
  <div class="scroll">
    ...
    <section id="before-math" data-level="curious">
      <h2 class="sec-head" style="--shadow: var(--peach); --tilt: -2deg;" data-text="THE OTHER LAB">THE OTHER LAB</h2>
      ...
      <details class="fold">
        <summary class="note">
          ...
          <p class="lvl lvl-pedantic">
            <b>tl;dr</b> A decade of work on measurement and inference where the observable is missing, degraded, or not addressed to the observer: motor intention from a thinning population of cortical units, affective state from ultrasonic vocalisation, proprioception without vision, lexical structure from partial parallelism, superconducting transition temperature from electronic structure. Two lines remain active.
          </p>
          <span class="fold-cue">
        ...
        <div class="papers" style="--accent: var(--pink);">
          ...
          <article class="paper">
            ...
            <p class="why unexpected">
              ...
              they went out under a Creative Commons licence instead. A patent would have meant the
          ...
          <article class="paper">
            ...
            <p class="meta">
              ...
              thousands of cells at once. It costs you depth — a millimetre or so even with
              two-photon, in an organ several centimetres thick — and temporal resolution,
            ...
            <p class="why echo">
              ...
              carbon fibres seven microns across, substrates stiff enough to go in and then soften
          ...
          <article class="paper">
            ...
            <p class="why">
              ...
              misplaced runs from a ruined week to a funeral. The idea was to hand the judgement
            ...
            <p class="meta">
              ...
              absorption signature, which would have read food about a centimetre deep without
        ...
        <div class="papers" style="--accent: var(--cyan);">
          ...
          <article class="paper">
            <h3>A dictionary for a language nobody could hear<span class="status">late 2013 – mid 2014</span><span class="tech">Computational bioacoustics · unsupervised clustering of rodent ultrasonic vocalisations · quasi-real-time monitoring in the animal’s own cage · preclinical safety pharmacology · affective-state readout · 3Rs refinement</span></h3>
          ...
          <article class="paper">
            ...
            <p class="why">
              ...
              the anaesthetic, so in practice that was one option. There is a third, and it is not
            ...
            <p class="meta">
              ...
              been emptied under anaesthetic and mechanical obstruction has been definitively
          ...
          <article class="paper">
            <h3><a href="https://rin.io/biome/">Everything downstream of a sensitive nervous system</a><span class="status">2024 – ongoing</span><span class="tech">Sensory processing as an organising principle · gut microbiome · autoimmunity · chronic pain · glutamate excitability · joint with Luca Estinto</span></h3>
        ...
        <div class="papers" style="--accent: var(--peach);">
          ...
          <article class="paper">
            <h3>When the cameras die, the hands take over<span class="status">Summer 2012</span><span class="tech">Proprioception-only contact-rich manipulation · blind peg-in-hole insertion · two-arm load equalisation · Willow Garage PR2 · human–robot interaction</span></h3>
          ...
          <article class="paper">
            ...
            <p class="meta">
              The first answer was colour — lock onto the histogram of whatever the person
            ...
            <p class="meta">
              ...
              count. A slope, a patch of gravel, a foot dropping into a dip a centimetre deeper
            ...
            <p class="why echo">
              ...
              and skittering back upright, and it is the approach that generalised. Quadrupeds now
          ...
          <article class="paper">
            <h3>Drawing the map while flying through it<span class="status">Fall 2013</span><span class="tech">Simultaneous localisation and mapping · monocular visual SLAM with parallax bootstrapping · loop closure · scale from sonar and inertial fusion · motion planning on a partial map</span></h3>
            ...
            <p class="meta">
              ...
              built out of the previous ones. You get it back by recognising somewhere you have
          ...
          <article class="paper">
            ...
            <p class="why">
              ...
              wrong. The one that decided it: a door labelled <em>electrical room</em> in print and
            ...
            <p class="meta">
              ...
              glued to its neighbours depending on where in the word it falls and what sits beside
              it.
            </p>
            <p class="meta">
          ...
          <article class="paper">
            <h3>Trying to keep clinical doctors up to date<span class="status">2013</span><span class="tech">Automated computational semantics · abstractive summarisation of biomedical literature · evidence fidelity</span></h3>
        ...
        <div class="papers" style="--accent: var(--yellow);">
          ...
          <article class="paper">
            <h3>Nothing interesting happens at only one scale<span class="status">Jan 2015</span><span class="tech">Multiscale modelling · directed type systems · compositional model building · topology applied to complex biological systems</span></h3>
            ...
            <p class="meta">
              ...
              categorically is a map whose fibres are the types. The two are the same construction
            ...
            <p class="meta">
              ...
              be specialised away. That is not speculative: eliminating array bound checks through dependent types
            ...
            <p class="why echo">
              ...
              on <em>Towards Directed Collapsibility</em> is in it: Nicole Sanderson now writes on
          ...
          <article class="paper">
            ...
            <p class="meta">
              I was given access to a hollow aluminium polyhedron, a vacuum pump and a
              ...
              there, and the discharge organises itself along the resulting standing wave. The point
          ...
          <article class="paper">
            <h3>A thinking film you could bend<span class="status">Spring 2012</span><span class="tech">Flexible TiO<sub>2</sub> resistive switching · memristive device fabrication and bend-cycle characterisation · in-memory computing</span></h3>
            ...
            <p class="meta">
              ...
              bending it and doing it again to find where the behaviour fell apart. It is also
            ...
            <p class="why echo">
              ...
              been making by hand. I had nothing to do with it, and it is still my favourite thing
        ...
        <div class="pro-group" style="--accent: var(--orange);">
          ...
          <div class="pro">
            ...
            <p>Autonomous acquisition of a shape-matched insertion task on a Willow Garage PR2 using commanded joint positions and gripper sensing only, with vision and external feedback disabled. Also <a href="https://link.springer.com/chapter/10.1007/978-3-319-00065-7_34">two-arm load equalisation</a> for objects with off-centre mass. HCI internship, George Washington University.</p>
          ...
          <div class="pro">
            ...
            <p>Hexapedal platform; target enrolment by proximity, association by gait rather than appearance, steering on bearing. Alternating tripod gait for statically stable traversal.</p>
            <p class="lim">Static stability is a guarantee over an idealised contact model and does not survive real terrain.</p>
          </div>
        </div>
        <div class="pro-group" style="--accent: var(--cyan);">
          <h3>Machine learning and signal processing</h3>
          <div class="pro">
            <h4>Unsupervised classification of rodent ultrasonic vocalisation for continuous preclinical monitoring<span class="yr">2013–2014</span></h4>
          ...
          <div class="pro">
            ...
            <p class="lim">Generalises to incompletely deciphered scripts. Applied motivation: transcription error in installed accessible signage.</p>
          </div>
          <div class="pro">
            <h4>Automated abstractive summarisation of biomedical literature for clinical readers<span class="yr">2013</span></h4>
            <p class="ptags"><span class="ptag">natural language processing</span><span class="ptag">summarisation</span><span class="ptag">biomedical text</span></p>
        ...
        <div class="pro-group" style="--accent: var(--violet);">
          <h3>Computational physics, materials and modelling</h3>
          <div class="pro">
            ...
            <p class="lim">Subsequently validated at scale by the <a href="https://www.nature.com/articles/s41586-019-1201-8">predicted-then-synthesised hydride superconductors</a>, at megabar pressures.</p>
          </div>
          <div class="pro">
          ...
          <div class="pro">
            ...
            <p>Fabrication and characterisation of <a href="https://www.nature.com/articles/nature06932">memristive devices</a> on compliant substrates, including switching behaviour under bend cycling. Research assistantship, Mary Baldwin College.</p>
          ...
          <div class="pro">
            ...
            <p>2.45&nbsp;GHz discharge in an evacuated aluminium polyhedron backfilled with argon; cavity geometry selects the supported resonant modes and the discharge organises along the resulting standing wave. Motivated by deployable conductive structures in ionospheric plasma.</p>
    ...
    <section>
      ...
      <div class="papers" style="--accent: var(--violet);">
        ...
        <article class="paper">
          <h3><a href="https://arxiv.org/abs/2509.23428">Moduli Stacks of <i>G</i>-Curves in Homotopy Theory at <i>h</i> = <i>p</i>−1</a><span class="status">updated Sept 2026</span></h3>
        ...
        <article class="paper">
          ...
          <p class="meta">
            ...
            sequence computing π<sub>∗</sub>(<i>E</i><sub>6</sub><sup><i>hC</i><sub>9</sub></sup>)
          </p>
    ...
    <section>
      ...
      <div class="note" style="--accent: var(--cyan);">
        ...
        <p>
          ...
          <i>p</i><sup><i>k</i>−1</sup>(<i>p</i>−1).
        </p>
      </div>

      <div class="papers" style="--accent: var(--cyan); margin-top: 1.6rem;">
        <article class="paper">
          <h3>Writhing Jewels: A Conjectural Description of the Lubin–Tate Action via Moduli Stacks of <i>G</i>-Curves for <i>h</i> = <i>p</i><sup><i>k</i>−1</sup>(<i>p</i>−1)</h3>
        </article>
        <article class="paper">
          ...
          <p class="chips">
            <a class="chip" href="http://rin.io/pdfs/Gauss_sums.pdf">Note toward this — PDF</a>
          </p>
        </article>
      </div>
    </section>
    ...
    <section>
      ...
      <div class="papers" style="--accent: var(--yellow);">
        <article class="paper">
          <h3><a href="https://rin.io/images/wp-content/uploads/2017/05/a1-2.pdf">Calculating π<sub>∗</sub>(tmf) at the prime 2</a></h3>
