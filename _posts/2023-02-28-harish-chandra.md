...
However, the symmetrization map is not a ring homomorphism. Duflo showed, however, that by **twisting** the symmetrization map, one obtains a ring homomorphism. 
