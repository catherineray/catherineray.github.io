...
\subsection{Filling in the Square}

We know the center of $U\mathfrak{sl}_2$ is generated by the Casimir operator $\Omega = EF + FE + \frac{1}{2} H^2$.
Hence, it suffices to diagram chase this generator through our square to conclude that our square commutes. We showed that the Duflo map sends the symmetrized Casimir operator $\frac{1}{2}H^2 + 2EF$ in $\mathfrak{g})^{\mathfrak g}$ to $\Omega + \frac{1}{2}.$ Further composing with the Harish-Chandra map gives that 
...
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	{\frac{1}{2}H^2 + 2EF} && {\frac{1}{2}\lambda^2} \\
	\\
	{\Omega + \frac{1}{2}} && {\frac{1}{2}\lambda^2 + \lambda + \frac{1}{2} = \frac{1}{2}(\lambda + 1)^2}
	\arrow["{\text{Duflo}}", maps to, from=1-1, to=3-1]
	\arrow["{\text{Chevalley}}", maps to, from=1-1, to=1-3]
	\arrow["{\text{Harish-Chandra}}", maps to, from=3-1, to=3-3]
	\arrow["{\rho\text{-shift}}", maps to, from=1-3, to=3-3]
\end{tikzcd}\]
